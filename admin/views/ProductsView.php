...
<div class="col-md-12">
    <div style="margin-bottom:5px;">
        <a href="index.php?controller=products&action=create" class="btn btn-success">Add product</a>
        <a href="index.php?controller=photo" class="btn btn-success">Add photo product</a>
    </div>
        ...
        <div class="panel-body">
            <table class="table table-bordered table-hover">
                ...
                <tr>
                    ...
                    <td>
                        <a href="index.php?controller=products&action=update&id=<?php echo $rows->id; ?>"><button type="button" class="btn btn-warning">Edit</button></a>
                    </td>
                    <td>
                        <a href="index.php?controller=products&action=delete&id=<?php echo $rows->id; ?>" onclick="return window.confirm('Are you sure?');"><button type="button" class="btn btn-danger">Delete</button></a>
                    </td>
                </tr>
                <?php endforeach; ?>
            </table>
